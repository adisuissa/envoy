...
public:
  ...
  // EdsResourcesCache
  void setResource(absl::string_view resource_name, const envoy::config::endpoint::v3::ClusterLoadAssignment& resource) override;
...
private:
  ...
  struct ResourceData {
    ...
    ResourceData(const envoy::config::endpoint::v3::ClusterLoadAssignment& resource) : resource_(resource) {}
  };
