...
class AdsIntegration2Test : public Grpc::DeltaSotwIntegrationParamTest, public HttpIntegrationTest {
public:
  AdsIntegration2Test(const envoy::config::core::v3::ApiVersion api_version);
  AdsIntegration2Test() : AdsIntegration2Test(envoy::config::core::v3::ApiVersion::V3) {}
